...
<div class="sidebar" id="sidebar">
    ...
    <a href="landpage.php" class="sidebar-link <?php echo ($current_page == 'landpage.php') ? 'active' : ''; ?>">
    ...
    <div class="dropdown <?php echo (in_array($current_page, $fvm_pages)) ? 'active' : ''; ?>">
        ...
        <div class="dropdown-menu">
            <a href="vehicle_list.php" class="sidebar-link <?php echo ($current_page == 'vehicle_list.php') ? 'active-sub' : ''; ?>">Vehicle List</a>
            <a href="maintenance_approval.php" class="sidebar-link <?php echo ($current_page == 'maintenance_approval.php') ? 'active-sub' : ''; ?>">Maintenance Approval</a>
            <a href="usage_logs.php" class="sidebar-link <?php echo ($current_page == 'usage_logs.php') ? 'active-sub' : ''; ?>">Usage Logs</a>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="dropdown <?php echo (in_array($current_page, $vrds_pages)) ? 'active' : ''; ?>">
        ...
        <div class="dropdown-menu">
            <a href="available_vehicles.php" class="sidebar-link <?php echo ($current_page == 'available_vehicles.php') ? 'active-sub' : ''; ?>">Available Vehicles</a>
            <a href="reservation_booking.php" class="sidebar-link <?php echo ($current_page == 'reservation_booking.php') ? 'active-sub' : ''; ?>">Reservation Booking</a>
            <a href="dispatch_control.php" class="sidebar-link <?php echo ($current_page == 'dispatch_control.php') ? 'active-sub' : ''; ?>">Dispatch & Trips</a>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="dropdown <?php echo (in_array($current_page, $dtpm_pages)) ? 'active' : ''; ?>">
        ...
        <div class="dropdown-menu">
            <a href="live_tracking.php" class="sidebar-link <?php echo ($current_page == 'live_tracking.php') ? 'active-sub' : ''; ?>">Live Tracking</a>
            <a href="driver_profiles.php" class="sidebar-link <?php echo ($current_page == 'driver_profiles.php') ? 'active-sub' : ''; ?>">Driver Profiles</a>
            <a href="trip_history.php" class="sidebar-link <?php echo ($current_page == 'trip_history.php') ? 'active-sub' : ''; ?>">Trip History</a>
            <a href="route_adherence.php" class="sidebar-link <?php echo ($current_page == 'route_adherence.php') ? 'active-sub' : ''; ?>">Route Adherence</a>
            <a href="driver_behavior.php" class="sidebar-link <?php echo ($current_page == 'driver_behavior.php') ? 'active-sub' : ''; ?>">Driver Behavior</a>
            <a href="delivery_status.php" class="sidebar-link <?php echo ($current_page == 'delivery_status.php') ? 'active-sub' : ''; ?>">Delivery Status</a>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="dropdown <?php echo (in_array($current_page, $tcao_pages)) ? 'active' : ''; ?>">
        ...
        <div class="dropdown-menu">
            <a href="cost_analysis.php" class="sidebar-link <?php echo ($current_page == 'cost_analysis.php') ? 'active-sub' : ''; ?>">Cost Analysis</a>
            <a href="trip_costs.php" class="sidebar-link <?php echo ($current_page == 'trip_costs.php') ? 'active-sub' : ''; ?>">Trip Costs</a>
            <a href="budget_management.php" class="sidebar-link <?php echo ($current_page == 'budget_management.php') ? 'active-sub' : ''; ?>">Budget Management</a>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="dropdown <?php echo (in_array($current_page, $ma_pages)) ? 'active' : ''; ?>">
        ...
        <div class="dropdown-menu">
            <a href="mobile_app.php" class="sidebar-link <?php echo ($current_page == 'mobile_app.php') ? 'active-sub' : ''; ?>">Driver App Sim</a>
            <a href="admin_alerts.php" class="sidebar-link <?php echo ($current_page == 'admin_alerts.php') ? 'active-sub' : ''; ?>">Emergency Alerts</a>
            <a href="admin_messaging.php" class="sidebar-link <?php echo ($current_page == 'admin_messaging.php') ? 'active-sub' : ''; ?>">Messaging</a>
        </div>
    </div>
    <?php endif; ?>
    
    <a href="logout.php" class="sidebar-link logout-link" id="logout-link">

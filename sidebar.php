...
<div id="sidebar" class="bg-gray-800 text-white w-64 min-h-screen flex flex-col fixed top-0 left-0 h-full z-10">
    ...
    <nav class="flex-1 px-2 py-4 space-y-2 overflow-y-auto">
        ...
        <?php if (in_array($user_role, $module_access['vrds'])): $is_active = is_module_active($vrds_pages, $currentPage); ?>
        ...
        <?php if (in_array($user_role, $module_access['tcao'])): $is_active = is_module_active($tcao_pages, $currentPage); ?>
            <button type="button" class="w-full flex items-center justify-between px-3 py-2 rounded-md hover:bg-gray-700 group <?= $is_active ? 'bg-gray-700' : '' ?>" data-submenu-toggle="tcao-submenu">
                <span class="flex items-center gap-3"><i data-lucide="bar-chart-2" class="w-5 h-5"></i><span class="sidebar-text">Transport Cost Analysis</span></span>
                <i data-lucide="chevron-down" class="w-4 h-4 transition-transform submenu-chevron <?= $is_active ? 'rotate-180' : '' ?>"></i>
            </button>
        ...
        <?php if (in_array($user_role, $module_access['ma'])): $is_active = is_module_active($ma_pages, $currentPage); ?>
            <button type="button" class="w-full flex items-center justify-between px-3 py-2 rounded-md hover:bg-gray-700 group <?= $is_active ? 'bg-gray-700' : '' ?>" data-submenu-toggle="ma-submenu">
                <span class="flex items-center gap-3"><i data-lucide="smartphone" class="w-5 h-5"></i><span class="sidebar-text">Mobile Fleet Command</span></span>
                <i data-lucide="chevron-down" class="w-4 h-4 transition-transform submenu-chevron <?= $is_active ? 'rotate-180' : '' ?>"></i>
            </button>
